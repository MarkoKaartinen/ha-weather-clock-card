 ...
 */
const Z = globalThis, G = Z.ShadowRoot && (Z.ShadyCSS === void 0 || Z.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), i2 = /* @__PURE__ */ new WeakMap();
let f2 = class {
  constructor(e, t, i) {
...
const E2 = (a) => new f2(typeof a == "string" ? a : a + "", void 0, X), m2 = (a, ...e) => {
  ...
  if (G) a.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, s2 = G ? (a) => a : (a) => a instanceof CSSStyleSheet ? ((e) => {
  let t = "";
...
let S = class extends HTMLElement {
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? n2;
  }
  static _$Ei() {
  ...
  requestUpdate(e, t, i, s = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), i ?? (i = o.getPropertyOptions(e)), !((i.hasChanged ?? Y)(r, t) || i.useDefault && i.reflect && r === ((n = this._$Ej) == null ? void 0 : n.get(e)) && !this.hasAttribute(o._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
function x(a, e, t = a, i) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((o = s == null ? void 0 : s._$AO) == null || o.call(s, !1), r === void 0 ? s = void 0 : (s = new r(a), s._$AT(a, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = s : t._$Cl = s), s !== void 0 && (e = x(a, s._$AS(a, e.values), s, i)), e;
}
class V2 {
  constructor(e, t) {
  ...
  u(e) {
    ...
    b.currentNode = s;
    let r = b.nextNode(), n = 0, o = 0, c = i[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let h;
        c.type === 2 ? h = new D(r, r.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (h = new K2(r, this, e)), this._$AV.push(h), c = i[++o];
      }
      n !== (c == null ? void 0 : c.index) && (r = b.nextNode(), n++);
    }
...
class D {
  ...
  _$AI(e, t = this) {
    e = x(this, e, t), P(e) ? e === u || e == null || e === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : e !== this._$AH && e !== L && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : F2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== u && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(k.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, s = 0;
    for (const r of e) s === t.length ? t.push(i = new D(this.O(N()), this.O(N()), this, this.options)) : i = t[s], i._$AI(r), s++;
...
class B {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let n = !1;
    if (r === void 0) e = x(this, e, t, 0), n = !P(e) || e !== this._$AH && e !== L, n && (this._$AH = e);
    else {
      const o = e;
      let c, h;
      for (e = r[0], c = 0; c < r.length - 1; c++) h = x(this, o[i + c], t, c), h === L && (h = this._$AH[c]), n || (n = !P(h) || h !== this._$AH[c]), h === u ? e = u : e !== u && (e += (h ?? "") + r[c + 1]), this._$AH[c] = h;
    }
    n && !s && this.j(e);
  }
  j(e) {
...
j == null || j(H, D), (T.litHtmlVersions ?? (T.litHtmlVersions = [])).push("3.3.3");
const j2 = (a, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let s = i._$litPart$;
  if (s === void 0) {
    const r = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = s = new D(e.insertBefore(N(), r), r, void 0, t ?? {});
  }
  return s._$AI(a), s;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const q2 = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: Y }, J2 = (a = q2, e, t) => {
 ...
 */
function U(a) {
  return t2({ ...a, state: !0, attribute: !1 });
}
...
let v = class extends A {
  ...
  async subscribeCalendar(e) {
    ...
    try {
      const s = await this.hass.connection.subscribeMessage((r) => {
        ...
        this.eventsByCalendar.set(e, n), this.events = [...this.eventsByCalendar.values()].flat().sort((c, h) => String(c.start).localeCompare(String(h.start)));
  ...
  t(e, t) {
    var s, r;
    const i = this.locale().toLowerCase().startsWith("fi") ? Q.card : z.card;
...
let O = class extends A {
  ...
  label(e) {
    var i;
    return ((i = this.hass) != null && i.locale.language.toLowerCase().startsWith("fi") ? Q.editor : z.editor)[e] ?? z.editor[e];
  }
  get formData() {
