...
var x2 = (n, e, t) => e in n ? L2(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var C = (n, e, t) => x2(n, typeof e != "symbol" ? e + "" : e, t);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = globalThis, Q = Z.ShadowRoot && (Z.ShadyCSS === void 0 || Z.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), i2 = /* @__PURE__ */ new WeakMap();
let f2 = class {
  constructor(e, t, i) {
...
const E2 = (n) => new f2(typeof n == "string" ? n : n + "", void 0, X), m2 = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: T2, defineProperty: N2, getOwnPropertyDescriptor: P2, getOwnPropertyNames: H2, getOwnPropertySymbols: O2, getPrototypeOf: U2 } = Object, v = globalThis, n2 = v.trustedTypes, D2 = n2 ? n2.emptyScript : "", W = v.reactiveElementPolyfillSupport, M = (n, e) => n, R = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? D2 : null;
      break;
  ...
  return t;
} }, Y = (n, e) => !T2(n, e), a2 = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: Y };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, r2 = (n) => n, V = T.trustedTypes, o2 = V ? V.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, y2 = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, v2 = "?" + y, F2 = `<${v2}>`, k = document, N = () => k.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", e2 = Array.isArray, I2 = (n) => e2(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", K = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, c2 = /-->/g, l2 = />/g, w = RegExp(`>|${K}(?:([^\\s"'>=/]+)(${K}*=${K}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), d2 = /'/g, h2 = /"/g, _2 = /^(?:script|style|textarea|title)$/i, Z2 = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), p = Z2(1), L = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), u2 = /* @__PURE__ */ new WeakMap(), b = k.createTreeWalker(k, 129);
function w2(n, e) {
...
const R2 = (n, e) => {
  ...
  for (let o = 0; o < t; o++) {
    const c = n[o];
    let l, u, d = -1, g = 0;
    for (; g < c.length && (a.lastIndex = g, u = a.exec(c), u !== null); ) g = a.lastIndex, a === E ? u[1] === "!--" ? a = c2 : u[1] !== void 0 ? a = l2 : u[2] !== void 0 ? (_2.test(u[2]) && (s = RegExp("</" + u[2], "g")), a = w) : u[3] !== void 0 && (a = w) : a === w ? u[0] === ">" ? (a = s ?? E, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, l = u[1], a = u[3] === void 0 ? w : u[3] === '"' ? h2 : d2) : a === h2 || a === d2 ? a = w : a === c2 || a === l2 ? a = E : (a = w, s = void 0);
    const m = a === w && n[o + 1].startsWith("/>") ? " " : "";
    r += a === E ? c + F2 : d >= 0 ? (i.push(l), c.slice(0, d) + y2 + c.slice(d) + y + m) : c + y + (d === -2 ? o : m);
  }
  return [w2(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class H {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, a = 0;
    const o = e.length - 1, c = this.parts, [l, u] = R2(e, t);
    ...
    for (; (s = b.nextNode()) !== null && c.length < o; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(y2)) {
          ...
          c.push({ type: 1, index: r, name: F[2], strings: m, ctor: F[1] === "." ? z2 : F[1] === "?" ? B2 : F[1] === "@" ? W2 : B }), s.removeAttribute(d);
...
class V2 {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let l;
        c.type === 2 ? l = new U(r, r.nextSibling, this, e) : c.type === 1 ? l = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (l = new K2(r, this, e)), this._$AV.push(l), c = i[++o];
      }
...
class U {
  ...
  $(e) {
    ...
    if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(t);
      ...
      const a = new V2(s, this), o = a.u(this.options);
...
var g2;
A._$litElement$ = !0, A.finalized = !0, (g2 = $.litElementHydrateSupport) == null || g2.call($, { LitElement: A });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const q2 = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: Y }, J2 = (n = q2, e, t) => {
...
function t2(n) {
  return (e, t) => typeof t == "object" ? J2(n, e, t) : ((i, s, r) => {
...
var S2 = Object.defineProperty, m0 = Object.getOwnPropertyDescriptor, y0 = (n, e, t) => e in n ? S2(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, f = (n, e, t, i) => {
  for (var s = i > 1 ? void 0 : i ? m0(e, t) : e, r = n.length - 1, a; r >= 0; r--)
...
let _ = class extends A {
  ...
  async fetchCalendars() {
    ...
    const i = this.config.calendars ?? [], s = await Promise.all(i.map(async (r) => {
      var o, c, l, u;
      try {
        const g = ((c = (o = (await this.hass.callWS({
          type: "call_service",
          domain: "calendar",
          service: "get_events",
      ...
      const a = (u = (l = this.hass) == null ? void 0 : l.states[r]) == null ? void 0 : u.attributes.message;
      return typeof a == "string" && a ? [{ summary: a, start: e.toISOString(), end: t.toISOString() }] : [];
    }));
  ...
  conditionLabel(e) {
    return e ? d0(e) ? (this.locale().toLowerCase().startsWith("fi") ? G.conditions : z.conditions)[e] ?? e.replaceAll("-", " ") : `${this.t("unknown_condition", "Unknown condition")}: ${e}` : "—";
  }
  renderForecast(e, t = !1) {
    ...
    return p`<div class="forecast-item">
      ...
      ${t ? h : p`<div class="wind">${p2(e.wind_bearing)} ${I(e.wind_speed, ((o = this.weatherEntity()) == null ? void 0 : o.attributes.wind_speed_unit) ?? "")}</div>${e.wind_gust_speed !== void 0 ? p`<div class="gust">💨 ${I(e.wind_gust_speed, ((c = this.weatherEntity()) == null ? void 0 : c.attributes.wind_speed_unit) ?? "")}</div>` : h}`}
    </div>`;
  }
  render() {
    var c;
    ...
    return p`<ha-card>
      ...
      return p`<div>${l.label}: ${J((d = (u = this.hass) == null ? void 0 : u.states[l.entity]) == null ? void 0 : d.state, l.unit ?? s)}</div>`;
          ...
          <div class="wind-details">${p2(t.wind_bearing)} ${I(t.wind_speed, t.wind_speed_unit ?? "")}${t.wind_gust_speed !== void 0 ? p`<span>💨 ${I(t.wind_gust_speed, t.wind_speed_unit ?? "")}</span>` : h}</div>
        </div>
