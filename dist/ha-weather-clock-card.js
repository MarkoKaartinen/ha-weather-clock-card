...
var E2 = (n, e, t) => e in n ? L2(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
 ...
 */
const I = globalThis, G = I.ShadowRoot && (I.ShadyCSS === void 0 || I.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Q = Symbol(), i2 = /* @__PURE__ */ new WeakMap();
let f2 = class {
  constructor(e, t, i) {
...
const x2 = (n) => new f2(typeof n == "string" ? n : n + "", void 0, Q), m2 = (n, ...e) => {
...
}, s2 = G ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: T2, defineProperty: N2, getOwnPropertyDescriptor: P2, getOwnPropertyNames: H2, getOwnPropertySymbols: O2, getPrototypeOf: U2 } = Object, v = globalThis, n2 = v.trustedTypes, F2 = n2 ? n2.emptyScript : "", W = v.reactiveElementPolyfillSupport, M = (n, e) => n, R = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? F2 : null;
      break;
  ...
  return t;
} }, X = (n, e) => !T2(n, e), a2 = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: X };
...
let A = class extends HTMLElement {
  ...
  static createProperty(e, t = a2) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      ...
      s !== void 0 && N2(this.prototype, e, s);
    }
  }
  static getPropertyDescriptor(e, t, i) {
    const { get: s, set: a } = P2(this.prototype, e) ?? { get() {
      return this[t];
    }, set(r) {
      this[t] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(M("properties"))) {
      const t = this.properties, i = [...H2(t), ...O2(t)];
  ...
  createRenderRoot() {
    ...
    return M2(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var e;
  ...
  _$ET(e, t) {
    ...
    if (s !== void 0 && i.reflect === !0) {
      const r = (((a = i.converter) == null ? void 0 : a.toAttribute) !== void 0 ? i.converter : R).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = i.getPropertyOptions(s), o = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((a = c.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? c.converter : R;
      this._$Em = s;
  ...
  requestUpdate(e, t, i, s = !1, a) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (a = this[e]), i ?? (i = c.getPropertyOptions(e)), !((i.hasChanged ?? X)(a, t) || i.useDefault && i.reflect && a === ((r = this._$Ej) == null ? void 0 : r.get(e)) && !this.hasAttribute(c._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[M("elementProperties")] = /* @__PURE__ */ new Map(), A[M("finalized")] = /* @__PURE__ */ new Map(), W == null || W({ ReactiveElement: A }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, r2 = (n) => n, V = T.trustedTypes, o2 = V ? V.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, y2 = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, v2 = "?" + y, D2 = `<${v2}>`, k = document, N = () => k.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", e2 = Array.isArray, Z2 = (n) => e2(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", K = `[ 	
\f\r]`, x = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, c2 = /-->/g, l2 = />/g, w = RegExp(`>|${K}(?:([^\\s"'>=/]+)(${K}*=${K}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), d2 = /'/g, h2 = /"/g, _2 = /^(?:script|style|textarea|title)$/i, I2 = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), p = I2(1), L = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), u2 = /* @__PURE__ */ new WeakMap(), b = k.createTreeWalker(k, 129);
function w2(n, e) {
...
const R2 = (n, e) => {
  ...
  let s, a = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = x;
  for (let c = 0; c < t; c++) {
    const o = n[c];
    let l, u, d = -1, g = 0;
    for (; g < o.length && (r.lastIndex = g, u = r.exec(o), u !== null); ) g = r.lastIndex, r === x ? u[1] === "!--" ? r = c2 : u[1] !== void 0 ? r = l2 : u[2] !== void 0 ? (_2.test(u[2]) && (s = RegExp("</" + u[2], "g")), r = w) : u[3] !== void 0 && (r = w) : r === w ? u[0] === ">" ? (r = s ?? x, d = -1) : u[1] === void 0 ? d = -2 : (d = r.lastIndex - u[2].length, l = u[1], r = u[3] === void 0 ? w : u[3] === '"' ? h2 : d2) : r === h2 || r === d2 ? r = w : r === c2 || r === l2 ? r = x : (r = w, s = void 0);
    const m = r === w && n[c + 1].startsWith("/>") ? " " : "";
    a += r === x ? o + D2 : d >= 0 ? (i.push(l), o.slice(0, d) + y2 + o.slice(d) + y + m) : o + y + (d === -2 ? c : m);
  }
  return [w2(n, a + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class H {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let a = 0, r = 0;
    const c = e.length - 1, o = this.parts, [l, u] = R2(e, t);
    ...
    for (; (s = b.nextNode()) !== null && o.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(y2)) {
          const g = u[r++], m = s.getAttribute(d).split(y), D = /([.?@])?(.*)/.exec(g);
          o.push({ type: 1, index: a, name: D[2], strings: m, ctor: D[1] === "." ? B2 : D[1] === "?" ? z2 : D[1] === "@" ? W2 : z }), s.removeAttribute(d);
        } else d.startsWith(y) && (o.push({ type: 6, index: a }), s.removeAttribute(d));
        if (_2.test(s.tagName)) {
          const d = s.textContent.split(y), g = d.length - 1;
          if (g > 0) {
            s.textContent = V ? V.emptyScript : "";
            for (let m = 0; m < g; m++) s.append(d[m], N()), b.nextNode(), o.push({ type: 2, index: ++a });
            s.append(d[g], N());
          }
        }
      } else if (s.nodeType === 8) if (s.data === v2) o.push({ type: 2, index: a });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(y, d + 1)) !== -1; ) o.push({ type: 7, index: a }), d += y.length - 1;
      }
      a++;
    }
  }
...
function E(n, e, t = n, i) {
  var r, c;
  if (e === L) return e;
  let s = i !== void 0 ? (r = t._$Co) == null ? void 0 : r[i] : t._$Cl;
  const a = P(e) ? void 0 : e._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== a && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), a === void 0 ? s = void 0 : (s = new a(n), s._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = s : t._$Cl = s), s !== void 0 && (e = E(n, s._$AS(n, e.values), s, i)), e;
}
class V2 {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; o !== void 0; ) {
      if (r === o.index) {
        let l;
        o.type === 2 ? l = new U(a, a.nextSibling, this, e) : o.type === 1 ? l = new o.ctor(a, o.name, o.strings, this, e) : o.type === 6 && (l = new K2(a, this, e)), this._$AV.push(l), o = i[++c];
      }
...
class U {
  ...
  _$AI(e, t = this) {
    e = E(this, e, t), P(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== L && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Z2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var a;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = H.createElement(w2(i.h, i.h[0]), this.options)), i);
    if (((a = this._$AH) == null ? void 0 : a._$AD) === s) this._$AH.p(t);
    else {
      const r = new V2(s, this), c = r.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, s = 0;
    for (const a of e) s === t.length ? t.push(i = new U(this.O(N()), this.O(N()), this, this.options)) : i = t[s], i._$AI(a), s++;
...
class z {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let r = !1;
    if (a === void 0) e = E(this, e, t, 0), r = !P(e) || e !== this._$AH && e !== L, r && (this._$AH = e);
    else {
      const c = e;
      let o, l;
      for (e = a[0], o = 0; o < a.length - 1; o++) l = E(this, c[i + o], t, o), l === L && (l = this._$AH[o]), r || (r = !P(l) || l !== this._$AH[o]), l === h ? e = h : e !== h && (e += (l ?? "") + a[o + 1]), this._$AH[o] = l;
    }
    r && !s && this.j(e);
  }
  j(e) {
...
const j2 = (n, e, t) => {
  ...
  if (s === void 0) {
    ...
    i._$litPart$ = s = new U(e.insertBefore(N(), a), a, void 0, t ?? {});
  }
  return s._$AI(n), s;
};
/**
...
class S extends A {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = j2(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var g2;
S._$litElement$ = !0, S.finalized = !0, (g2 = $.litElementHydrateSupport) == null || g2.call($, { LitElement: S });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const q2 = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: X }, J2 = (n = q2, e, t) => {
...
function t2(n) {
  return (e, t) => typeof t == "object" ? J2(n, e, t) : ((i, s, a) => {
...
const v0 = {
  ...
  "not-available": $2,
  overcast: i0,
  "partly-cloudy-day": s0,
  "partly-cloudy-night": n0,
  rain: a0,
  snow: r0,
  thunderstorms: o0,
  wind: c0
...
let _ = class extends S {
    ...
    const e = async (t, i, s) => {
      try {
        const a = await this.hass.connection.subscribeMessage(
          (r) => {
            var c;
            return s(r.forecast ?? ((c = r.event) == null ? void 0 : c.forecast) ?? []);
          },
  ...
  async subscribeCalendar(e) {
    ...
    try {
      const s = await this.hass.connection.subscribeMessage((a) => {
        var c;
        const r = a.events ?? ((c = a.event) == null ? void 0 : c.events) ?? [];
  ...
  t(e, t) {
    var s, a;
    const i = this.locale().toLowerCase().startsWith("fi") ? Y.card : B.card;
  ...
  conditionLabel(e) {
    return e ? d0(e) ? (this.locale().toLowerCase().startsWith("fi") ? Y.conditions : B.conditions)[e] ?? e.replaceAll("-", " ") : `${this.t("unknown_condition", "Unknown condition")}: ${e}` : "—";
  }
  renderForecast(e, t = !1) {
    var r, c, o;
    const i = ((r = this.weatherEntity()) == null ? void 0 : r.attributes.temperature_unit) ?? "°", s = C2(e.datetime), a = t ? new Intl.DateTimeFormat(this.locale(), { weekday: "short", day: "numeric", month: "numeric" }).format(s) : this.formatTime(s);
    return p`<div class="forecast-item">
      ...
      ${t ? h : p`<div class="wind">${p2(e.wind_bearing)} ${Z(e.wind_speed, ((c = this.weatherEntity()) == null ? void 0 : c.attributes.wind_speed_unit) ?? "")}</div>${e.wind_gust_speed !== void 0 ? p`<div class="gust">💨 ${Z(e.wind_gust_speed, ((o = this.weatherEntity()) == null ? void 0 : o.attributes.wind_speed_unit) ?? "")}</div>` : h}`}
    </div>`;
  }
  render() {
    var o;
    ...
    return p`<ha-card>
      <section class="current" part="current">
        <div class="current-copy">
          ...
          <div class="temperature-row"><div class="temperature">${J(a, s)}</div>
      ...
      ${r.length ? p`<section class="forecast hourly" part="hourly-forecast">${r.map((l) => this.renderForecast(l))}</section>` : h}
      ${c.length ? p`<section class="forecast daily" part="daily-forecast">${c.map((l) => this.renderForecast(l, !0))}</section>` : h}
    </ha-card>`;
  }
  eventTime(e) {
...
let O = class extends S {
  ...
  label(e) {
    var i;
    return ((i = this.hass) != null && i.locale.language.toLowerCase().startsWith("fi") ? Y.editor : B.editor)[e] ?? B.editor[e];
  }
  render() {
    var e;
    return p`<ha-card><div class="editor"><ha-form .hass=${this.hass} .data=${this.config} .computeLabel=${(t) => this.label(t.name)} .schema=${[
...
S2(O, "styles", m2`.editor { padding: 16px; } p { color: var(--secondary-text-color); font-size:.9rem; }`);
f([
  t2({ attribute: !1 })
], O.prototype, "hass", 2);
f([
