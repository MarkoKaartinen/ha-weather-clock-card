...
var M2 = (a, e, t) => e in a ? x2(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t;
var u = (a, e, t) => M2(a, typeof e != "symbol" ? e + "" : e, t);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const D = globalThis, J = D.ShadowRoot && (D.ShadyCSS === void 0 || D.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Y = Symbol(), e2 = /* @__PURE__ */ new WeakMap();
let C2 = class {
  constructor(e, t, i) {
  ...
  get styleSheet() {
    ...
    if (J && e === void 0) {
      ...
      i && (e = e2.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && e2.set(t, e));
    }
    return e;
  }
  toString() {
...
const S2 = (a) => new C2(typeof a == "string" ? a : a + "", void 0, Y), g2 = (a, ...e) => {
  const t = a.length === 1 ? a[0] : e.reduce((i, s, n) => i + ((r) => {
  ...
  if (J) a.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, t2 = J ? (a) => a : (a) => a instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: E2, defineProperty: T2, getOwnPropertyDescriptor: N2, getOwnPropertyNames: P2, getOwnPropertySymbols: H2, getPrototypeOf: F2 } = Object, y = globalThis, i2 = y.trustedTypes, Z2 = i2 ? i2.emptyScript : "", z = y.reactiveElementPolyfillSupport, E = (a, e) => a, O = { toAttribute(a, e) {
  switch (e) {
    case Boolean:
      a = a ? Z2 : null;
      break;
  ...
  return t;
} }, G = (a, e) => !E2(a, e), s2 = { attribute: !0, type: String, converter: O, reflect: !1, useDefault: !1, hasChanged: G };
...
let A = class extends HTMLElement {
  ...
  static createProperty(e, t = s2) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      const i = Symbol(), s = this.getPropertyDescriptor(e, i, t);
      s !== void 0 && T2(this.prototype, e, s);
    }
  }
  static getPropertyDescriptor(e, t, i) {
    const { get: s, set: n } = N2(this.prototype, e) ?? { get() {
      return this[t];
    }, set(r) {
      this[t] = r;
    } };
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? s2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(E("properties"))) {
      const t = this.properties, i = [...P2(t), ...H2(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of i) t.unshift(t2(s));
    } else e !== void 0 && t.push(t2(e));
    return t;
  }
  static _$Eu(e, t) {
    const i = t.attribute;
  ...
  _$ET(e, t) {
    ...
    if (s !== void 0 && i.reflect === !0) {
      const r = (((n = i.converter) == null ? void 0 : n.toAttribute) !== void 0 ? i.converter : O).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = i.getPropertyOptions(s), o = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((n = c.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? c.converter : O;
      this._$Em = s;
      const l = o.fromAttribute(t, c.type);
  ...
  requestUpdate(e, t, i, s = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (n = this[e]), i ?? (i = c.getPropertyOptions(e)), !((i.hasChanged ?? G)(n, t) || i.useDefault && i.reflect && n === ((r = this._$Ej) == null ? void 0 : r.get(e)) && !this.hasAttribute(c._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (s.size > 0) for (const [n, r] of s) {
        const { wrapped: c } = r, o = this[n];
        c !== !0 || this._$AL.has(n) || o === void 0 || this.C(n, void 0, r, o);
      }
    }
    let e = !1;
    const t = this._$AL;
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[E("elementProperties")] = /* @__PURE__ */ new Map(), A[E("finalized")] = /* @__PURE__ */ new Map(), z == null || z({ ReactiveElement: A }), (y.reactiveElementVersions ?? (y.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, a2 = (a) => a, U = T.trustedTypes, n2 = U ? U.createPolicy("lit-html", { createHTML: (a) => a }) : void 0, f2 = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, m2 = "?" + m, D2 = `<${m2}>`, k = document, N = () => k.createComment(""), P = (a) => a === null || typeof a != "object" && typeof a != "function", Q = Array.isArray, O2 = (a) => Q(a) || typeof (a == null ? void 0 : a[Symbol.iterator]) == "function", I = `[ 	
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, r2 = /-->/g, o2 = />/g, w = RegExp(`>|${I}(?:([^\\s"'>=/]+)(${I}*=${I}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), c2 = /'/g, l2 = /"/g, y2 = /^(?:script|style|textarea|title)$/i, U2 = (a) => (e, ...t) => ({ _$litType$: a, strings: e, values: t }), C = U2(1), M = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), d2 = /* @__PURE__ */ new WeakMap(), b = k.createTreeWalker(k, 129);
function v2(a, e) {
  if (!Q(a) || !a.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return n2 !== void 0 ? n2.createHTML(e) : e;
}
const V2 = (a, e) => {
  const t = a.length - 1, i = [];
  let s, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = L;
  for (let c = 0; c < t; c++) {
    const o = a[c];
    let l, p, d = -1, g = 0;
    for (; g < o.length && (r.lastIndex = g, p = r.exec(o), p !== null); ) g = r.lastIndex, r === L ? p[1] === "!--" ? r = r2 : p[1] !== void 0 ? r = o2 : p[2] !== void 0 ? (y2.test(p[2]) && (s = RegExp("</" + p[2], "g")), r = w) : p[3] !== void 0 && (r = w) : r === w ? p[0] === ">" ? (r = s ?? L, d = -1) : p[1] === void 0 ? d = -2 : (d = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? w : p[3] === '"' ? l2 : c2) : r === l2 || r === c2 ? r = w : r === r2 || r === o2 ? r = L : (r = w, s = void 0);
    const f = r === w && a[c + 1].startsWith("/>") ? " " : "";
    n += r === L ? o + D2 : d >= 0 ? (i.push(l), o.slice(0, d) + f2 + o.slice(d) + m + f) : o + m + (d === -2 ? c : f);
  }
  return [v2(a, n + (a[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class H {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let n = 0, r = 0;
    const c = e.length - 1, o = this.parts, [l, p] = V2(e, t);
    if (this.el = H.createElement(l, i), b.currentNode = this.el.content, t === 2 || t === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = b.nextNode()) !== null && o.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(f2)) {
          const g = p[r++], f = s.getAttribute(d).split(m), Z = /([.?@])?(.*)/.exec(g);
          o.push({ type: 1, index: n, name: Z[2], strings: f, ctor: Z[1] === "." ? R2 : Z[1] === "?" ? z2 : Z[1] === "@" ? I2 : B }), s.removeAttribute(d);
        } else d.startsWith(m) && (o.push({ type: 6, index: n }), s.removeAttribute(d));
        if (y2.test(s.tagName)) {
          const d = s.textContent.split(m), g = d.length - 1;
          if (g > 0) {
            s.textContent = U ? U.emptyScript : "";
            for (let f = 0; f < g; f++) s.append(d[f], N()), b.nextNode(), o.push({ type: 2, index: ++n });
            s.append(d[g], N());
          }
        }
      } else if (s.nodeType === 8) if (s.data === m2) o.push({ type: 2, index: n });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(m, d + 1)) !== -1; ) o.push({ type: 7, index: n }), d += m.length - 1;
      }
      n++;
    }
  }
...
function S(a, e, t = a, i) {
  var r, c;
  if (e === M) return e;
  let s = i !== void 0 ? (r = t._$Co) == null ? void 0 : r[i] : t._$Cl;
  const n = P(e) ? void 0 : e._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== n && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), n === void 0 ? s = void 0 : (s = new n(a), s._$AT(a, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = s : t._$Cl = s), s !== void 0 && (e = S(a, s._$AS(a, e.values), s, i)), e;
}
class B2 {
  constructor(e, t) {
  ...
  u(e) {
    ...
    b.currentNode = s;
    let n = b.nextNode(), r = 0, c = 0, o = i[0];
    for (; o !== void 0; ) {
      if (r === o.index) {
        let l;
        o.type === 2 ? l = new F(n, n.nextSibling, this, e) : o.type === 1 ? l = new o.ctor(n, o.name, o.strings, this, e) : o.type === 6 && (l = new j2(n, this, e)), this._$AV.push(l), o = i[++c];
      }
      r !== (o == null ? void 0 : o.index) && (n = b.nextNode(), r++);
    }
...
class F {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), P(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== M && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : O2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var n;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = H.createElement(v2(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === s) this._$AH.p(t);
    else {
      const r = new B2(s, this), c = r.u(this.options);
      r.p(t), this.T(c), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = d2.get(e.strings);
    return t === void 0 && d2.set(e.strings, t = new H(e)), t;
  }
  k(e) {
    Q(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, s = 0;
    for (const n of e) s === t.length ? t.push(i = new F(this.O(N()), this.O(N()), this, this.options)) : i = t[s], i._$AI(n), s++;
    s < t.length && (this._$AR(i && i._$AB.nextSibling, s), t.length = s);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    var i;
    for ((i = this._$AP) == null ? void 0 : i.call(this, !1, !0, t); e !== this._$AB; ) {
      const s = a2(e).nextSibling;
      a2(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
class B {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let r = !1;
    if (n === void 0) e = S(this, e, t, 0), r = !P(e) || e !== this._$AH && e !== M, r && (this._$AH = e);
    else {
      const c = e;
      let o, l;
      for (e = n[0], o = 0; o < n.length - 1; o++) l = S(this, c[i + o], t, o), l === M && (l = this._$AH[o]), r || (r = !P(l) || l !== this._$AH[o]), l === h ? e = h : e !== h && (e += (l ?? "") + n[o + 1]), this._$AH[o] = l;
    }
    r && !s && this.j(e);
  }
  j(e) {
...
j == null || j(H, F), (T.litHtmlVersions ?? (T.litHtmlVersions = [])).push("3.3.3");
const W2 = (a, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let s = i._$litPart$;
  if (s === void 0) {
    const n = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = s = new F(e.insertBefore(N(), n), n, void 0, t ?? {});
  }
  return s._$AI(a), s;
};
/**
...
class x extends A {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = W2(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var u2;
x._$litElement$ = !0, x.finalized = !0, (u2 = $.litElementHydrateSupport) == null || u2.call($, { LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const q2 = { attribute: !0, type: String, converter: O, reflect: !1, hasChanged: G }, K2 = (a = q2, e, t) => {
  ...
  if (n === void 0 && globalThis.litPropertyMetadata.set(s, n = /* @__PURE__ */ new Map()), i === "setter" && ((a = Object.create(a)).wrapped = !0), n.set(t.name, a), i === "accessor") {
    ...
    return { set(c) {
      ...
      e.set.call(this, c), this.requestUpdate(r, o, a, !0, c);
    }, init(c) {
      return c !== void 0 && this.C(r, void 0, a, c), c;
    } };
  }
  if (i === "setter") {
    const { name: r } = t;
    return function(c) {
      const o = this[r];
      e.call(this, c), this.requestUpdate(r, o, a, !0, c);
    };
  }
  throw Error("Unsupported decorator location: " + i);
};
function X(a) {
  return (e, t) => typeof t == "object" ? K2(a, e, t) : ((i, s, n) => {
...
function h2(a) {
  return typeof a == "number" ? ["↑", "↗", "→", "↘", "↓", "↙", "←", "↖"][Math.round(a / 45) % 8] : {
    N: "↑",
    NE: "↗",
    E: "→",
    SE: "↘",
...
const d0 = { current_weather: "Current weather", hourly_weather: "Hourly forecast weather entity", daily_weather: "Daily forecast weather entity", temperature_entity: "Primary temperature sensor", calendars: "Calendars", hourly_forecast_count: "Hourly forecast count", daily_forecast_count: "Daily forecast count", show_calendar: "Show calendar" }, h0 = { today: "Today", no_events: "No events today", all_day: "All day", unknown_condition: "Unknown condition" }, K = {
  editor: d0,
  card: h0
}, p0 = { current_weather: "Nykyinen sää", hourly_weather: "Tuntiennusteen sääentiteetti", daily_weather: "Päiväennusteen sääentiteetti", temperature_entity: "Ensisijainen lämpötila-anturi", calendars: "Kalenterit", hourly_forecast_count: "Tuntiennusteiden määrä", daily_forecast_count: "Päiväennusteiden määrä", show_calendar: "Näytä kalenteri" }, u0 = { today: "Tänään", no_events: "Ei tapahtumia tänään", all_day: "Koko päivä", unknown_condition: "Tuntematon säätila" }, $2 = {
  editor: p0,
  card: u0
};
var k2 = Object.defineProperty, C0 = Object.getOwnPropertyDescriptor, g0 = (a, e, t) => e in a ? k2(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t, _ = (a, e, t, i) => {
  for (var s = i > 1 ? void 0 : i ? C0(e, t) : e, n = a.length - 1, r; n >= 0; n--)
    (r = a[n]) && (s = (i ? r(e, t, s) : r(s)) || s);
  return i && s && k2(e, t, s), s;
}, A2 = (a, e, t) => g0(a, e + "", t);
const f0 = {
  "clear-day": J2,
  "clear-night": Y2,
  ...
  "not-available": w2,
  overcast: t0,
  "partly-cloudy-day": i0,
  "partly-cloudy-night": s0,
  rain: a0,
  snow: n0,
  thunderstorms: r0,
  wind: o0
...
let v = class extends x {
  constructor() {
    ...
    u(this, "daily", []);
    u(this, "events", []);
    u(this, "now", /* @__PURE__ */ new Date());
    u(this, "config");
    u(this, "unsubscribers", []);
    u(this, "eventsByCalendar", /* @__PURE__ */ new Map());
    u(this, "clock");
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.clock = window.setInterval(() => this.now = /* @__PURE__ */ new Date(), 1e4);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.clock && window.clearInterval(this.clock), this.clearSubscriptions();
  }
  updated(e) {
    e.has("hass") && this.subscribeData();
  }
  clearSubscriptions() {
  ...
  async subscribeData() {
    ...
    await Promise.all([
      e(this.config.hourly_weather ?? this.config.current_weather, "hourly", (t) => this.hourly = t),
      e(this.config.daily_weather ?? this.config.current_weather, "daily", (t) => this.daily = t),
      ...(this.config.calendars ?? []).map((t) => this.subscribeCalendar(t))
    ]);
  }
  async subscribeCalendar(e) {
    ...
    try {
      const s = await this.hass.connection.subscribeMessage((n) => {
        var c;
        const r = ((c = n.event) == null ? void 0 : c.events) ?? [];
        this.eventsByCalendar.set(e, r), this.events = [...this.eventsByCalendar.values()].flat().sort((o, l) => String(o.start).localeCompare(String(l.start)));
  ...
  t(e, t) {
    var s, n;
    const i = this.locale().toLowerCase().startsWith("fi") ? $2.card : K.card;
    return ((n = (s = this.config) == null ? void 0 : s.labels) == null ? void 0 : n[e]) ?? i[e] ?? t;
  }
  locale() {
    var e;
  ...
  icon(e, t) {
    const i = t ? [21, 22, 23, 0, 1, 2, 3, 4, 5].includes(p2(t).getHours()) : this.now.getHours() < 6 || this.now.getHours() > 20;
    return f0[c0(e, i)] ?? w2;
  }
  renderForecast(e, t = !1) {
    var r;
    const i = ((r = this.weatherEntity()) == null ? void 0 : r.attributes.temperature_unit) ?? "°", s = p2(e.datetime), n = t ? new Intl.DateTimeFormat(this.locale(), { weekday: "short", day: "numeric", month: "numeric" }).format(s) : this.formatTime(s);
    return C`<div class="forecast-item">
      ...
      ${t ? h : C`<div class="wind">${h2(e.wind_bearing)} ${e.wind_speed ?? "—"}</div><div class="gust">💨 ${e.wind_gust_speed ?? "—"}</div>`}
    </div>`;
  }
  render() {
    var o;
    if (!this.config || !this.hass) return C``;
    const e = this.weatherEntity(), t = (e == null ? void 0 : e.attributes) ?? {}, i = e == null ? void 0 : e.state, s = t.temperature_unit ?? "°", n = this.config.temperature_entity ? (o = this.hass.states[this.config.temperature_entity]) == null ? void 0 : o.state : t.temperature, r = this.hourly.slice(0, this.config.hourly_forecast_count ?? 5), c = this.daily.slice(0, this.config.daily_forecast_count ?? 5);
    return C`<ha-card>
      <section class="current" part="current">
        <div class="current-copy">
          ...
          <div class="condition">${l0(i) ? i == null ? void 0 : i.replaceAll("-", " ") : `${this.t("unknown_condition", "Unknown condition")}: ${i ?? "—"}`}</div>
          <div class="temperature-row"><div class="temperature">${q(n, s)}</div>
            <div class="sensor-list">${(this.config.sensors ?? []).map((l) => {
      var p, d;
      return C`<div>${l.label}: ${q((d = (p = this.hass) == null ? void 0 : p.states[l.entity]) == null ? void 0 : d.state, l.unit ?? s)}</div>`;
    })}</div>
          </div>
          <div class="wind-details">${h2(t.wind_bearing)} ${t.wind_speed ?? "—"} ${t.wind_speed_unit ?? ""} <span>💨 ${t.wind_gust_speed ?? "—"} ${t.wind_speed_unit ?? ""}</span></div>
        </div>
        <img class="current-icon" src=${this.icon(i)} alt=${i ?? ""} />
      </section>
      ${this.config.show_calendar !== !1 ? C`<section class="calendar" part="calendar"><ha-icon icon="mdi:calendar-today"></ha-icon><div><strong>${this.t("today", "Today")}</strong>${this.events.length ? this.events.map((l) => C`<div>${this.eventTime(l)} ${l.summary ?? ""}</div>`) : C`<div class="muted">${this.t("no_events", "No events today")}</div>`}</div></section>` : h}
      ${r.length ? C`<section class="forecast hourly" part="hourly-forecast">${r.map((l) => this.renderForecast(l))}</section>` : h}
      ${c.length ? C`<section class="forecast daily" part="daily-forecast">${c.map((l) => this.renderForecast(l, !0))}</section>` : h}
    </ha-card>`;
  }
  eventTime(e) {
...
A2(v, "styles", g2`
    ...
    section { box-sizing:border-box; } .current { display:flex; justify-content:space-between; gap:16px; padding:28px 40px; } .date,.condition { font-weight:700; text-transform:uppercase; letter-spacing:.02em; } .date { font-size:1.25rem; } .clock { display:block; font-size:var(--weather-clock-clock-size); font-weight:800; line-height:1; margin:12px 0 34px; letter-spacing:-.06em; } .condition { font-size:1.2rem; } .temperature-row { display:flex; align-items:center; gap:22px; margin:7px 0 12px; } .temperature { font-size:3.5rem; font-weight:800; letter-spacing:-.06em; } .sensor-list { font-weight:700; line-height:1.45; } .wind-details { font-weight:700; } .wind-details span { margin-left:12px; } .current-icon { width:var(--weather-clock-icon-size); min-width:var(--weather-clock-icon-size); object-fit:contain; }
    .calendar { display:flex; gap:18px; align-items:flex-start; padding:16px 40px; border-top:1px solid var(--divider-color); border-bottom:1px solid var(--divider-color); } .calendar ha-icon { color:var(--weather-clock-accent); } .calendar strong { display:block; margin-bottom:3px; } .muted { color:var(--secondary-text-color); }
    .forecast { display:flex; justify-content:space-around; gap:8px; padding:26px 24px; } .daily { border-top:1px solid var(--divider-color); } .forecast-item { flex:1 1 0; min-width:0; text-align:center; font-weight:700; } .forecast-time { min-height:2.3em; font-size:1.05rem; text-transform:capitalize; } .forecast-icon { display:block; width:60px; height:60px; object-fit:contain; margin:8px auto; } .forecast-temperature { font-size:1.55rem; } .wind,.gust { white-space:nowrap; margin-top:8px; font-size:.95rem; }
...
v = _([
  _2("weather-clock-card")
], v);
let V = class extends x {
  constructor() {
    super(...arguments);
    u(this, "hass");
    u(this, "config", { current_weather: "" });
  }
  setConfig(e) {
    this.config = { type: "custom:weather-clock-card", ...e };
  }
  change() {
  ...
  label(e) {
    var i;
    return ((i = this.hass) != null && i.locale.language.toLowerCase().startsWith("fi") ? $2.editor : K.editor)[e] ?? K.editor[e];
  }
  render() {
    var e;
    return C`<ha-card><div class="editor"><ha-form .hass=${this.hass} .data=${this.config} .computeLabel=${(t) => this.label(t.name)} .schema=${[
      ...
      this.config = { ...this.config, ...t.detail.value }, this.change();
    }}></ha-form><p>${(e = this.hass) != null && e.locale.language.toLowerCase().startsWith("fi") ? "Määritä nimetyt lisäsensorit YAMLissa sensors:-avaimella." : "Configure additional named sensors in YAML with the sensors: key."}</p></div></ha-card>`;
  }
};
A2(V, "styles", g2`.editor { padding: 16px; } p { color: var(--secondary-text-color); font-size:.9rem; }`);
_([
  X({ attribute: !1 })
], V.prototype, "hass", 2);
V = _([
  _2("weather-clock-card-editor")
], V);
