...
var A2 = (n, e, t) => e in n ? k2(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var C = (n, e, t) => A2(n, typeof e != "symbol" ? e + "" : e, t);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, K = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, J = Symbol(), X = /* @__PURE__ */ new WeakMap();
let C2 = class {
  constructor(e, t, i) {
...
const x2 = (n) => new C2(typeof n == "string" ? n : n + "", void 0, J), u2 = (n, ...e) => {
  ...
  if (K) n.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of e) {
    const i = document.createElement("style"), s = O.litNonce;
    s !== void 0 && i.setAttribute("nonce", s), i.textContent = t.cssText, n.appendChild(i);
  }
}, e2 = K ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: M2, defineProperty: L2, getOwnPropertyDescriptor: E2, getOwnPropertyNames: T2, getOwnPropertySymbols: N2, getPrototypeOf: P2 } = Object, y = globalThis, t2 = y.trustedTypes, H2 = t2 ? t2.emptyScript : "", z = y.reactiveElementPolyfillSupport, E = (n, e) => n, U = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? H2 : null;
      break;
  ...
  return t;
} }, Y = (n, e) => !M2(n, e), i2 = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: Y };
...
let A = class extends HTMLElement {
  ...
  static createProperty(e, t = i2) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      const i = Symbol(), s = this.getPropertyDescriptor(e, i, t);
      s !== void 0 && L2(this.prototype, e, s);
    }
  }
  static getPropertyDescriptor(e, t, i) {
    const { get: s, set: a } = E2(this.prototype, e) ?? { get() {
      return this[t];
    }, set(r) {
      this[t] = r;
    } };
    return { get: s, set(r) {
      ...
      a == null || a.call(this, r), this.requestUpdate(e, c, i);
    }, configurable: !0, enumerable: !0 };
  }
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? i2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(E("properties"))) {
      const t = this.properties, i = [...T2(t), ...N2(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of i) t.unshift(e2(s));
    } else e !== void 0 && t.push(e2(e));
    return t;
  }
  static _$Eu(e, t) {
    const i = t.attribute;
  ...
  _$ET(e, t) {
    ...
    if (s !== void 0 && i.reflect === !0) {
      const r = (((a = i.converter) == null ? void 0 : a.toAttribute) !== void 0 ? i.converter : U).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = i.getPropertyOptions(s), o = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((a = c.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? c.converter : U;
      this._$Em = s;
  ...
  requestUpdate(e, t, i, s = !1, a) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (a = this[e]), i ?? (i = c.getPropertyOptions(e)), !((i.hasChanged ?? Y)(a, t) || i.useDefault && i.reflect && a === ((r = this._$Ej) == null ? void 0 : r.get(e)) && !this.hasAttribute(c._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (s.size > 0) for (const [a, r] of s) {
        const { wrapped: c } = r, o = this[a];
        c !== !0 || this._$AL.has(a) || o === void 0 || this.C(a, void 0, r, o);
      }
    }
    let e = !1;
    const t = this._$AL;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, s2 = (n) => n, D = T.trustedTypes, n2 = D ? D.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, g2 = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, f2 = "?" + m, F2 = `<${f2}>`, k = document, N = () => k.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", G = Array.isArray, Z2 = (n) => G(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", I = `[ 	
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, a2 = /-->/g, r2 = />/g, w = RegExp(`>|${I}(?:([^\\s"'>=/]+)(${I}*=${I}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), o2 = /'/g, c2 = /"/g, m2 = /^(?:script|style|textarea|title)$/i, O2 = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), u = O2(1), S = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), l2 = /* @__PURE__ */ new WeakMap(), b = k.createTreeWalker(k, 129);
function y2(n, e) {
...
const U2 = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const o = n[c];
    let l, p, d = -1, g = 0;
    for (; g < o.length && (r.lastIndex = g, p = r.exec(o), p !== null); ) g = r.lastIndex, r === L ? p[1] === "!--" ? r = a2 : p[1] !== void 0 ? r = r2 : p[2] !== void 0 ? (m2.test(p[2]) && (s = RegExp("</" + p[2], "g")), r = w) : p[3] !== void 0 && (r = w) : r === w ? p[0] === ">" ? (r = s ?? L, d = -1) : p[1] === void 0 ? d = -2 : (d = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? w : p[3] === '"' ? c2 : o2) : r === c2 || r === o2 ? r = w : r === a2 || r === r2 ? r = L : (r = w, s = void 0);
    const f = r === w && n[c + 1].startsWith("/>") ? " " : "";
    a += r === L ? o + F2 : d >= 0 ? (i.push(l), o.slice(0, d) + g2 + o.slice(d) + m + f) : o + m + (d === -2 ? c : f);
  }
  return [y2(n, a + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class H {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let a = 0, r = 0;
    const c = e.length - 1, o = this.parts, [l, p] = U2(e, t);
    ...
    for (; (s = b.nextNode()) !== null && o.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(g2)) {
          const g = p[r++], f = s.getAttribute(d).split(m), Z = /([.?@])?(.*)/.exec(g);
          o.push({ type: 1, index: a, name: Z[2], strings: f, ctor: Z[1] === "." ? V2 : Z[1] === "?" ? B2 : Z[1] === "@" ? R2 : B }), s.removeAttribute(d);
        } else d.startsWith(m) && (o.push({ type: 6, index: a }), s.removeAttribute(d));
        if (m2.test(s.tagName)) {
          const d = s.textContent.split(m), g = d.length - 1;
          if (g > 0) {
            s.textContent = D ? D.emptyScript : "";
            for (let f = 0; f < g; f++) s.append(d[f], N()), b.nextNode(), o.push({ type: 2, index: ++a });
            s.append(d[g], N());
          }
        }
      } else if (s.nodeType === 8) if (s.data === f2) o.push({ type: 2, index: a });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(m, d + 1)) !== -1; ) o.push({ type: 7, index: a }), d += m.length - 1;
      }
      a++;
    }
  }
...
function M(n, e, t = n, i) {
  ...
  return (s == null ? void 0 : s.constructor) !== a && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), a === void 0 ? s = void 0 : (s = new a(n), s._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = s : t._$Cl = s), s !== void 0 && (e = M(n, s._$AS(n, e.values), s, i)), e;
}
class D2 {
  constructor(e, t) {
  ...
  u(e) {
    ...
    b.currentNode = s;
    let a = b.nextNode(), r = 0, c = 0, o = i[0];
    for (; o !== void 0; ) {
      if (r === o.index) {
        let l;
        o.type === 2 ? l = new F(a, a.nextSibling, this, e) : o.type === 1 ? l = new o.ctor(a, o.name, o.strings, this, e) : o.type === 6 && (l = new z2(a, this, e)), this._$AV.push(l), o = i[++c];
      }
      r !== (o == null ? void 0 : o.index) && (a = b.nextNode(), r++);
    }
...
class F {
  ...
  _$AI(e, t = this) {
    e = M(this, e, t), P(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Z2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var a;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = H.createElement(y2(i.h, i.h[0]), this.options)), i);
    if (((a = this._$AH) == null ? void 0 : a._$AD) === s) this._$AH.p(t);
    else {
      const r = new D2(s, this), c = r.u(this.options);
      r.p(t), this.T(c), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = l2.get(e.strings);
    return t === void 0 && l2.set(e.strings, t = new H(e)), t;
  }
  k(e) {
    G(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, s = 0;
    for (const a of e) s === t.length ? t.push(i = new F(this.O(N()), this.O(N()), this, this.options)) : i = t[s], i._$AI(a), s++;
    s < t.length && (this._$AR(i && i._$AB.nextSibling, s), t.length = s);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    var i;
    for ((i = this._$AP) == null ? void 0 : i.call(this, !1, !0, t); e !== this._$AB; ) {
      const s = s2(e).nextSibling;
      s2(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
class B {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let r = !1;
    if (a === void 0) e = M(this, e, t, 0), r = !P(e) || e !== this._$AH && e !== S, r && (this._$AH = e);
    else {
      const c = e;
      let o, l;
      for (e = a[0], o = 0; o < a.length - 1; o++) l = M(this, c[i + o], t, o), l === S && (l = this._$AH[o]), r || (r = !P(l) || l !== this._$AH[o]), l === h ? e = h : e !== h && (e += (l ?? "") + a[o + 1]), this._$AH[o] = l;
    }
    r && !s && this.j(e);
  }
  j(e) {
...
const I2 = (n, e, t) => {
  ...
  if (s === void 0) {
    ...
    i._$litPart$ = s = new F(e.insertBefore(N(), a), a, void 0, t ?? {});
  }
  return s._$AI(n), s;
};
/**
...
class x extends A {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = I2(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var p2;
x._$litElement$ = !0, x.finalized = !0, (p2 = $.litElementHydrateSupport) == null || p2.call($, { LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const j2 = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: Y }, W2 = (n = j2, e, t) => {
  const { kind: i, metadata: s } = t;
  let a = globalThis.litPropertyMetadata.get(s);
  if (a === void 0 && globalThis.litPropertyMetadata.set(s, a = /* @__PURE__ */ new Map()), i === "setter" && ((n = Object.create(n)).wrapped = !0), a.set(t.name, n), i === "accessor") {
    const { name: r } = t;
    return { set(c) {
      const o = e.get.call(this);
      e.set.call(this, c), this.requestUpdate(r, o, n, !0, c);
    }, init(c) {
  ...
  if (i === "setter") {
    ...
    return function(c) {
      const o = this[r];
      e.call(this, c), this.requestUpdate(r, o, n, !0, c);
    };
  }
  throw Error("Unsupported decorator location: " + i);
};
function Q(n) {
  return (e, t) => typeof t == "object" ? W2(n, e, t) : ((i, s, a) => {
...
function d2(n) {
  return typeof n == "number" ? ["↑", "↗", "→", "↘", "↓", "↙", "←", "↖"][Math.round(n / 45) % 8] : {
    N: "↑",
    NE: "↗",
    E: "→",
    SE: "↘",
...
const c0 = { today: "Today", no_events: "No events today", all_day: "All day", unknown_condition: "Unknown condition" }, l0 = {
  card: c0
}, d0 = { today: "Tänään", no_events: "Ei tapahtumia tänään", all_day: "Koko päivä", unknown_condition: "Tuntematon säätila" }, h0 = {
  card: d0
};
var b2 = Object.defineProperty, p0 = Object.getOwnPropertyDescriptor, C0 = (n, e, t) => e in n ? b2(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, _ = (n, e, t, i) => {
  for (var s = i > 1 ? void 0 : i ? p0(e, t) : e, a = n.length - 1, r; a >= 0; a--)
    (r = n[a]) && (s = (i ? r(e, t, s) : r(s)) || s);
  return i && s && b2(e, t, s), s;
}, $2 = (n, e, t) => C0(n, e + "", t);
const u0 = {
  "clear-day": q2,
  "clear-night": K2,
  ...
  "not-available": _2,
  overcast: X2,
  "partly-cloudy-day": e0,
  "partly-cloudy-night": t0,
  rain: i0,
  snow: s0,
  thunderstorms: n0,
  wind: a0
...
let v = class extends x {
  ...
  async subscribeData() {
    ...
    const e = async (t, i, s) => {
      try {
        const a = await this.hass.connection.subscribeMessage(
          (r) => s(r.forecast ?? []),
  ...
  async subscribeCalendar(e) {
    ...
    try {
      const s = await this.hass.connection.subscribeMessage((a) => {
        var c;
        const r = ((c = a.event) == null ? void 0 : c.events) ?? [];
  ...
  t(e, t) {
    var s, a;
    const i = this.locale().toLowerCase().startsWith("fi") ? h0.card : l0.card;
    return ((a = (s = this.config) == null ? void 0 : s.labels) == null ? void 0 : a[e]) ?? i[e] ?? t;
  }
  locale() {
    var e;
  ...
  icon(e, t) {
    const i = t ? [21, 22, 23, 0, 1, 2, 3, 4, 5].includes(h2(t).getHours()) : this.now.getHours() < 6 || this.now.getHours() > 20;
    return u0[r0(e, i)] ?? _2;
  }
  renderForecast(e, t = !1) {
    var r;
    const i = ((r = this.weatherEntity()) == null ? void 0 : r.attributes.temperature_unit) ?? "°", s = h2(e.datetime), a = t ? new Intl.DateTimeFormat(this.locale(), { weekday: "short", day: "numeric", month: "numeric" }).format(s) : this.formatTime(s);
    return u`<div class="forecast-item">
      <div class="forecast-time">${a}</div>
      ...
      ${t ? h : u`<div class="wind">${d2(e.wind_bearing)} ${e.wind_speed ?? "—"}</div><div class="gust">💨 ${e.wind_gust_speed ?? "—"}</div>`}
    </div>`;
  }
  render() {
    var o;
    if (!this.config || !this.hass) return u``;
    const e = this.weatherEntity(), t = (e == null ? void 0 : e.attributes) ?? {}, i = e == null ? void 0 : e.state, s = t.temperature_unit ?? "°", a = this.config.temperature_entity ? (o = this.hass.states[this.config.temperature_entity]) == null ? void 0 : o.state : t.temperature, r = this.hourly.slice(0, this.config.hourly_forecast_count ?? 5), c = this.daily.slice(0, this.config.daily_forecast_count ?? 5);
    return u`<ha-card>
      <section class="current" part="current">
        <div class="current-copy">
          ...
          <div class="condition">${o0(i) ? i == null ? void 0 : i.replaceAll("-", " ") : `${this.t("unknown_condition", "Unknown condition")}: ${i ?? "—"}`}</div>
          <div class="temperature-row"><div class="temperature">${q(a, s)}</div>
            <div class="sensor-list">${(this.config.sensors ?? []).map((l) => {
      var p, d;
      return u`<div>${l.label}: ${q((d = (p = this.hass) == null ? void 0 : p.states[l.entity]) == null ? void 0 : d.state, l.unit ?? s)}</div>`;
    })}</div>
          </div>
          <div class="wind-details">${d2(t.wind_bearing)} ${t.wind_speed ?? "—"} ${t.wind_speed_unit ?? ""} <span>💨 ${t.wind_gust_speed ?? "—"} ${t.wind_speed_unit ?? ""}</span></div>
        </div>
        <img class="current-icon" src=${this.icon(i)} alt=${i ?? ""} />
      </section>
      ${this.config.show_calendar !== !1 ? u`<section class="calendar" part="calendar"><ha-icon icon="mdi:calendar-today"></ha-icon><div><strong>${this.t("today", "Today")}</strong>${this.events.length ? this.events.map((l) => u`<div>${this.eventTime(l)} ${l.summary ?? ""}</div>`) : u`<div class="muted">${this.t("no_events", "No events today")}</div>`}</div></section>` : h}
      ${r.length ? u`<section class="forecast hourly" part="hourly-forecast">${r.map((l) => this.renderForecast(l))}</section>` : h}
      ${c.length ? u`<section class="forecast daily" part="daily-forecast">${c.map((l) => this.renderForecast(l, !0))}</section>` : h}
    </ha-card>`;
  }
  eventTime(e) {
...
let V = class extends x {
  ...
  change(e, t) {
    this.config = { ...this.config, [e]: t }, this.dispatchEvent(new CustomEvent("config-changed", { detail: { config: this.config }, bubbles: !0, composed: !0 }));
  }
  render() {
    return u`<ha-card><div class="editor"><ha-form .hass=${this.hass} .data=${this.config} .schema=${[
      ...
      this.config = e.detail.value, this.change("current_weather", this.config.current_weather);
    }}></ha-form><p>Configure additional named sensors in YAML with <code>sensors:</code>.</p></div></ha-card>`;
  }
};
$2(V, "styles", u2`.editor { padding: 16px; } p { color: var(--secondary-text-color); font-size:.9rem; }`);
_([
  Q({ attribute: !1 })
], V.prototype, "hass", 2);
V = _([
  v2("weather-clock-card-editor")
], V);
